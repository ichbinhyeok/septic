...
public final class CountyAccessProfileCatalog {
    ...
    private static final Map<String, CountyAccessProfileView> PROFILES = Map.ofEntries(
            ...
            Map.entry("IN::st-joseph-county", profile(
                    ...
                    "https://www.in.gov/localhealth/stjosephcounty/files/Schematic-Request-Form.pdf",
                    "Read the county schematic instructions",
                    "https://www.in.gov/localhealth/stjosephcounty/environmental-health/septic-systems/",
            ...
            Map.entry("VA::prince-william-county", profile(
                    ...
                    "phone_assisted",
                    "Accessible Health District instructions",
                    "Start with Prince William On-Site Sewage & Water Services",
                    "The Health District's accessible service page explains the historical repository and publishes the On-Site Sewage & Water Services contact. Use it first; the document portal can be tried only as a secondary historical lookup because it may return 403.",
                    "Open On-Site Sewage & Water Services",
                    "https://www.vdh.virginia.gov/prince-william/environmental-health/onsite-sewage-and-water-services/",
                    "Try the historical document portal (may block)",
            ...
            Map.entry("TX::tarrant-county", profile(
                    ...
                    "Confirm that Tarrant County or a contract city owns the OSSF file through the accessible OSSF office page. When the county owns it, use the official Public Information Act instructions, which publish email, mail, fax, and in-person alternatives to the access-restricted portal.",
                    "Open the Tarrant County OSSF office",
                    "https://www.tarrantcountytx.gov/en/engineering-services/environmental/ossf.html",
                    "Open official Public Information Act instructions",
            ...
            Map.entry("MD::st-marys-county", profile(
                    "MD::st-marys-county",
                    "official_request",
                    "Official Environmental Health request",
                    "Request the St. Mary's County Environmental Health property file",
                    "Use the Health Department's official Public Information Act PDF for the septic, perc, approval, and repair file. The county GIS is only a secondary parcel and Tax ID lookup; it does not establish that a septic record was found.",
                    ...
                    "Look up a parcel or Tax ID in county GIS",
                    ...
                    "The GIS can supply a parcel clue, but it is not the septic-record source. Only the Health Department response can establish a file or official no-record result.",
                    ...
                    List.of(
                            "Prepare the property address, owner, and Tax Map, Grid, and Parcel when available.",
                            "Complete and sign the official Public Information Act PDF, then email it to Environmental Health.",
                            "Keep the submission copy and return with the file or written no-record/referral response."
                    )
            )),
            ...
            Map.entry("CA::san-bernardino-county", profile(
                    ...
                    "phone_assisted",
                    "Phone-confirmed records intake",
                    "Call San Bernardino Environmental Health to confirm records intake",
                    "The linked NextRequest portal returns a Cloudflare 403 in a clean browser. Call Environmental Health first with the prepared property and record scope; use the county-authored records form only after the office confirms the current return channel.",
                    "Call Environmental Health records intake",
                    "tel:800-442-2283",
                    "Open the county-authored records request form",
                    "https://ehs.sbcounty.gov/wp-content/uploads/sites/97/Programs/WaterAndWaste/RecordsRequestForm.pdf",
                    "The requested Environmental Health file, a request reference, or a written no-record/referral response",
                    "The current portal returned a Cloudflare 403 in a clean browser. The official PDF remains county-hosted, but confirm its current email, fax, mail, or office return channel before sending it.",
                    ...
                    List.of(
                            ...
                            "Call 800-442-2283 with the carry sheet and confirm the current email, fax, mail, or office intake.",
                            "Use the county-authored form only through the channel the office confirms.",
